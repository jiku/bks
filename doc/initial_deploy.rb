...
set :scm, :git
sets :scm_username, "prism"
sets :scm_password, "megaman"

role :app, "sonik.nu"
role :web, "sonik.nu"
role :db,  "sonik.nu", :primary => true
...
namespace :slice do
  ...
  task :install_rails_stack do
    [
      ...
      "mkdir -p src",
      "cd src",
      "wget http://rubyforge.org/frs/download.php/29548/rubygems-2.0.5.tgz",
      "tar xvzf rubygems-2.0.5.tgz",
      "cd rubygems-2.0.5/ && sudo ruby setup.rb",
...
RailsSpawnServer /usr/lib/ruby/gems/1.8/gems/passenger-2.0.5/bin/passenger-spawn-server
